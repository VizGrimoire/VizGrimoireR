...
#SCM
LANG= R_LIBS=../r-lib:$R_LIBS R --vanilla --args -d $1 -u root -i $1 -r repositories,companies -s 2010-05-27 -e 2013-04-04 -g weeks < scm-analysis.R
#MLS
LANG= R_LIBS=../r-lib:$R_LIBS R --vanilla --args -d $2 -u root -i $1 -r repositories,companies -s 2010-05-27 -e 2013-04-04 -g weeks < mls-analysis.R
#ITS
LANG= R_LIBS=../r-lib:$R_LIBS R --vanilla --args -d $3 -u root -i $1 -r repositories,companies -s 2010-05-27 -e 2013-04-04 -g weeks -t launchpad < its-analysis.R
