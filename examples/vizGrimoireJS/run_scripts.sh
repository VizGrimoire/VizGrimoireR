...
#ITS
R --vanilla --args -d $3 -u root -i $1 -r repositories -s 2010-05-01 -e 2013-04-05 -g weeks -t launchpad < its-analysis.R
R --vanilla --args -d $3 -u root -i $1 -r companies -s 2010-05-01 -e 2013-04-05 -g weeks -t launchpad < its-analysis.R
